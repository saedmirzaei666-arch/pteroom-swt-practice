...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const isCmd = text.startsWith("/quiz_wfd") || text.startsWith("/quiz_stop") || text.startsWith("/quiz_status");
    if (isCmd) {
    ...
    if (text.startsWith("/quiz_wfd")) {
      const n = Number(text.split(/\s+/)[1] || 5);
